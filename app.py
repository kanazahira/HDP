...
@st.cache_resource
def load_model():
    return joblib.load("lightgbm_smote.pkl")
...
with tab2:
    ...
    Hasil evaluasi <b>3 model × 2 teknik handling imbalance</b> (SMOTE vs class_weight) pada test set 20%.
    ...
    for col, title, body, color, bg in [
        (ex1,"⚠️  Accuracy","Mengukur persentase prediksi yang benar secara keseluruhan, tetapi belum menunjukkan kemampuan model dalam menemukan pasien yang berisiko penyakit jantung.","#b45309","#fffbeb"),
        (ex2,"⚠️  ROC-AUC","Mengukur kemampuan model membedakan pasien sakit dan sehat, namun belum secara langsung menggambarkan keseimbangan antara deteksi kasus positif dan false alarm.","#b45309","#fffbeb"),
        (ex3,"✅  PR-AUC","Berfokus pada Precision dan Recall, sehingga lebih mencerminkan kemampuan model menemukan pasien berisiko penyakit jantung sekaligus mengurangi false alarm.","#15803d","#f0fdf4"),
    ]:
        col.markdown(f"""
...
with tab4:
    ...
    with a1:
        ...
        <div style="background:#ffffff;border-radius:14px;padding:20px 22px;
          ...
          <div style="font-size:14px;font-weight:600;color:#1a2f6e;line-height:1.6;">
            ...
            Perbandingan Logistic Regression, XGBoost, dan LightGBM
          </div>
        </div>
        <div style="background:#ffffff;border-radius:14px;padding:20px 22px;
    ...
    with a2:
        ...
        <div style="background:#ffffff;border-radius:14px;padding:20px 22px;
          ...
          <div style="font-size:13.5px;color:#374151;line-height:2.0;">
            ✅ &nbsp;3 Model: Logistic Regression · XGBoost · LightGBM<br>
            ✅ &nbsp;2 Teknik: SMOTE vs class_weight<br>
            ✅ &nbsp;Tuning: Optuna (40 trials · 5-fold Stratified CV)<br>
            ✅ &nbsp;Metrik: PR-AUC · ROC-AUC · F1 · Precision · Recall<br>
