...
with tab2:
    ...
    results_data = {
        ...
        "PR-AUC":    [0.9421, 0.9398, 0.9387, 0.9354, 0.9102, 0.9089],
        "ROC-AUC":   [0.9512, 0.9488, 0.9476, 0.9445, 0.9201, 0.9187],
        "Accuracy":  [0.8859, 0.8804, 0.8750, 0.8696, 0.8478, 0.8424],
        "F1-Score":  [0.8923, 0.8876, 0.8831, 0.8784, 0.8562, 0.8511],
        "Precision": [0.8901, 0.8854, 0.8812, 0.8761, 0.8534, 0.8487],
        "Recall":    [0.8945, 0.8897, 0.8850, 0.8807, 0.8590, 0.8535],
    }
